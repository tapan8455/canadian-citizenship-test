      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-20 relative">
        ...
        <div className="max-w-4xl w-full text-center relative z-10 animate-enter">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            ...
            <Link 
              href="/study-guide" 
              className="w-full sm:w-auto px-10 py-5 rounded-2xl font-extrabold text-slate-600 text-xl bg-white border-2 border-slate-200 border-b-[8px] hover:bg-slate-50 active:border-b-[2px] active:translate-y-[6px] transition-all"
            >
              Read Study Guide
            </Link>
          </div>
